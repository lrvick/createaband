...
function forums()	{
	...
	$start=($page-1)*20;
	$sql_query="select * from f_categories limit $start,20";
	$res=sql_execute($sql_query,'res');
	$p_sql="select f_cat_id from f_categories";
        ...
        <td width="80%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr> 
              <td align="left" valign="top" class="body"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr> 
                    <td height="19" class="title">&nbsp;&nbsp;<?=LNG_FORUMS?></td>
                  </tr>
                  <tr> 
                    <td class="body">&nbsp;</td>
                  </tr>
                                ...
                                <td align="center" class="body"><table width="98%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr> 
                                      <td width="54%" valign="top" class="form-comment"> 
                                        <font size="2"><strong><a href="index.php?mode=forums&act=viewcat&seid=<?=$row->f_cat_id?>&lng=<?=$lng_id?>"> 
          ...
          </table></td><td width="15%" valign="top" align="center"><script language="Javascript"></script></td>
      </tr>
    </table>
	<?php
	show_footer();
...
function viewcat()	{
	...
	if(empty($page))	$page=1;
	$start=($page-1)*20;
	$sql_f="select * from forums where f_c_id=$seid and f_st='P' limit $start,20";	
	$res_f=mysql_query($sql_f);
	$p_sql="select f_id from forums where f_c_id=$seid and f_st='P'";
	$p_url="index.php?mode=forums&act=viewcat&seid=$seid&lng=" . $lng_id;
      ...
      <tr>
        <td width="85%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr> 
              <td align="left" valign="top" class="body"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr> 
                    <td height="19" class="title">&nbsp;&nbsp;<a href="index.php?mode=forums&page=<?=$page?>&lng=<?=$lng_id?>"><?=LNG_FORUMS?></a> 
                      &nbsp;>>&nbsp;<a href="index.php?mode=forums&act=viewcat&seid=<?=$seid?>&lng=<?=$lng_id?>"><?=stripslashes($row_fcat->name)?></a>
					  &nbsp;>>&nbsp;<?=LNG_VIEW_FORUM?></td>
                  </tr>
                  <tr> 
                    <td align="center" valign="middle" class="body">
    				<!--
    				Change $row_f to $row_fat
    				-->	                
                  ...
                  <tr>
                    <td align="left" valign="middle" class="body">&nbsp;<a href="index.php?mode=forums&act=create&cat=<?=$seid?>&pr=p&lng=<?=$lng_id?>"><?=LNG_START_NEW_TOPIC?></a></td>
                  </tr>
                  <tr> 
                    <td class="body"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr> 
                                ...
                                <td align="center" class="body"><table width="98%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr valign="middle"> 
                                      <td width="52%" height="30" class="body"> 
                                        <font size="2"><strong><a href="index.php?mode=forums&act=viewforum&cats=<?=$seid?>&seid=<?=$row_f->f_id?>&page=<?=$page?>&lng=<?=$lng_id?>"> 
          ...
          </table></td><td valign="top" align="center" width="15%"><script language="Javascript"></script></td>
      </tr>
    </table>
	<?php
	show_footer();
...
function viewforum()	{
	...
	if(empty($page))	$page=1;
	$start=($page-1)*20;
	$sql_f="select * from forums where f_rid='$seid' and f_st='R' limit $start,20";
	$res_f=mysql_query($sql_f);
	$p_sql="select * from forums where f_rid='$seid' and f_st='R'";
	$p_url="index.php?mode=forums&act=viewforum&cats=$cats&seid=$seid&lng=" . $lng_id;
        ...
        <td width="85%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr> 
              <td align="left" valign="top" class="body"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr> 
                    <td height="19" class="title">&nbsp;&nbsp;<a href="index.php?mode=forums&page=<?=$page?>&lng=<?=$lng_id?>"><?=LNG_FORUMS?></a> 
                      &nbsp;>>&nbsp;<a href="index.php?mode=forums&act=viewcat&seid=<?=$cats?>&lng=<?=$lng_id?>"><?=stripslashes($row_fcat->name)?></a> &nbsp;>>&nbsp;<?=LNG_VIEW_REPLIES?></td>
                  </tr>
                  <tr>
                    <td height="19" class="body">&nbsp;&nbsp;<?=LNG_TOPICS?> : <a href="index.php?mode=forums&act=viewforum&cats=<?=$cats?>&seid=<?=$seid?>&page=<?=$page?>&lng=<?=$lng_id?>"><?=stripslashes($row_h->f_matt)?></a></td>
                  </tr>
                  <tr> 
                    <td align="center" valign="middle" class="body"> 
                  ...
                  <tr> 
                    <td align="left" valign="middle" class="body">&nbsp;<a href="index.php?mode=forums&act=create&cat=<?=$cats?>&pr=r&qst=<?=$seid?>&lng=<?=$lng_id?>"><?=LNG_POST_REPLY?></a></td>
                  </tr>
                  <tr> 
                    <td class="body"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr> 
          ...
          </table></td><td width="15%" align="center" valign="top"><script language="Javascript"></script></td>
      </tr>
    </table>
	<?php
	show_footer();
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="body">
      <tr>
        <td width="85%" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr> 
                        ...
                        <tr> 
                          <td width="86%" align="left" valign="top"> <table width="100%" border="0" cellpadding="0" cellspacing="0" class="lined">
                              <tr> 
                                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr> 
                                      <td height="20" align="left" valign="middle" class="lined title">&nbsp;&nbsp;<?php if($pr=='p') { echo LNG_POST_THREAD; } elseif($pr=='r') { ?><?=LNG_POST_REPLY?><?php } ?></td>
                                    </tr>
                                      ...
                                      <td align="left" valign="middle" class="text"> 
                                        <form name="form1" method="post" action="index.php">
                                          <table width="75%" border="0" align="center" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr> 
                                              <td width="44%" class="body">&nbsp;&nbsp;<?php if($pr=='p') { ?><?=LNG_THREAD?><?php } elseif($pr=='r') { ?><?=LNG_REPLY?><?php } ?></td>
                                            ...
                                            <tr> 
                                              <td colspan="2" align="center"><input type="submit" name="Submit" value="<?php if($pr=='p') { ?><?=LNG_POST_THREAD?><?php } elseif($pr=='r') { ?><?=LNG_POST_REPLY?><?php } ?>"></td>
                                            </tr>
                                            <tr> 
                                              <td colspan="2" align="center"></td>
                                            </tr>
	...
	<table width="100%" cellpadding="0" cellspacing="0" align="center">
		  <tr>
			<td valign="top" width="85%"><table width="100%" border="0" cellpadding="0" cellspacing="0">
								  ...
								  <tr> 
                                            ...
                                            <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                ...
                                                <tr> 
                                                  ...
                                                  <td width="30%" align="right" valign="top" class="body"> 
                                                    ...
                                                    <?php } ?>&nbsp;&nbsp;<a href="index.php?mode=<?=$mode?>&act=create&page=<?=$page?>&cat=<?=$row_fcat->f_cat_id?>&qst=<?=$row_for->f_id?>&pr=r&lng=<?=$lng_id?>"><?=LNG_POST_REPLY?></a>&nbsp;&nbsp;
													</td>
                                                </tr>
                                                <tr> 
                                                  <td colspan="3">&nbsp;</td>
                                    ...
                                    <tr> 
                                      <td width="93%" height="20" align="right" valign="middle" class="body"> 
                                        <?php show_page_nos($sql_for,"index.php?mode=$mode&lng=$lng_id",$lines10,$page,$wh); ?>
                                      </td>
                                      <?php } ?>
			  ...
			  </table></td><td valign="top" width="15%" align="center"><script language="Javascript"></script></td>
		  </tr>
		</table>
	<?php
	show_footer();
...
function lpost_pos($id)	{
	...
	if((!empty($max_id)) || ($max_id!=0))	{
		...
		echo "<a href='index.php?mode=forums&act=viewforum&cats=$id&seid=$max_id&lng=$lng_id'>".$titl."</a>";
