                          ...
                          <td width="86%" valign="top"><table width="100%" height="100%" border="0" align="right" cellpadding="0" cellspacing="0" class="body">
                              <tr> 
                                <td align="right"> <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" class="lined">
                                    ...
                                    <tr> 
                                      <td align="right" class="body"><a href="admin.php?mode=news&act=create&adsess=<?=$adsess?>">Post 
                                        New Article</a>&nbsp;&nbsp;</td>
                                    </tr>
                                    <tr> 
                                                  ...
                                                  <td width="98%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                      ...
                                                      <tr> 
                                                        ...
                                                        <td width="20%" align="right" class="body"> 
                                                          ...
                                                          <a href="admin.php?mode=news&act=ednews&seid=<?=$row_mails->id?>">Edit</a>&nbsp;&nbsp;<a href="admin.php?mode=news&act=remnews&seid=<?=$row_mails->id?>&page=<?=$page?>">Delete</a> 
                                                          <?php } ?>
                                                        </td>
                                                      </tr>
                                                      <tr> 
                                                        ...
                                                        <td colspan="2"> <table width="89%" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr>
                                                              <td align="right" class="body"> 
                                                                <a href="admin.php?mode=news&act=view&seid=<?=$row_mails->id?>&adsess=<?=$adsess?>">Full 
                                                                Story</a>&nbsp;&nbsp;<a href="admin.php?mode=news&act=ednews&seid=<?=$row_mails->id?>&adsess=<?=$adsess?>">Edit</a>&nbsp;&nbsp;<a href="admin.php?mode=news&act=remnews&seid=<?=$row_mails->id?>&adsess=<?=$adsess?>">Delete</a> 
                                                                &nbsp;&nbsp;</td>
                                                            </tr>
                                                          </table></td>
                                                      </tr>
        ...
        <td><table width="780" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr> 
              <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr> 
                    <td align="right" class="body"><a href="admin.php?mode=news&adsess=<?=$adsess?>">View 
                      Posts</a>&nbsp;&nbsp;</td>
                  </tr>
                  <tr> 
...
function create_done()	{
	...
	if((empty($matt)) || (empty($title)) || (empty($source)) || (empty($link))) 	{
		...
		$hed="admin.php?mode=news&act=create&err_mess=$matt&adsess=$adsess";
	}	else	{
		$sql_ins="insert into news (own,title,source,matt,link,rapzone,dt) values (";
		...
		if(!empty($tmpfname))	{
			...
			$sql_query="update news set photo='$photo',photo_thumb='$photo_thumb' where id='$prim'";
			sql_execute($sql_query,'');
		}
		$matt="The Article is Added";
		$hed="admin.php?mode=news&err_mess=$matt&adsess=$adsess";
	}
	show_screen($hed);
}
function ednews()	{
        ...
        <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr> 
              ...
              <td width="663" align="left" valign="top" class="body"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr> 
                    <td align="right" class="body"><a href="admin.php?mode=news&adsess=<?=$adsess?>">View Articles</a>&nbsp;&nbsp;</td>
                  </tr>
                  <tr> 
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr> 
...
function modnews()	{
	...
	if((empty($matt)) || (empty($title)) || (empty($source)) || (empty($link)))	{
		...
		$hed="admin.php?mode=news&act=ednews&seid=$seid&err_mess=$matt&adsess=$adsess";
	}	else	{
		$sql_ins="update news set title='".addslashes($title)."',source='".addslashes($source)."',matt='".addslashes($matt)."',link='$link',rapzone='".addslashes($zones)."' where id=$seid";
		mysql_query($sql_ins);
		$prim=$seid;
		if(!empty($tmpfname))	{
			$path="news";
                                ...
                                <td width="86%" align="left" valign="top"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" class="lined">
                                    <tr> 
                                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                          ...
                                          <tr> 
                                            <td align="right" class="body"><a href="admin.php?mode=news&adsess=<?=$adsess?>">View Articles 
                                              </a>&nbsp;&nbsp;</td>
                                          </tr>
                                          <tr> 
                                            <td align="left" valign="top" class="body"> 
                                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr align="right"> 
                                                  <td colspan="3" class="body"> 
                                                    <a href="admin.php?mode=news&act=ednews&seid=<?=$seid?>&adsess=<?=$adsess?>">Edit</a>&nbsp;&nbsp;<a href="admin.php?mode=news&act=remnews&seid=<?=$seid?>&adsess=<?=$adsess?>">Delete</a>&nbsp;&nbsp; 
                                                    &nbsp;</td>
                                                </tr>
                                        </table></td>
                                    </tr>
